...
:: URL 路徑
set "SC0101001-Application=management/Application"
set "SC0102001-Review=management/Review"
set "SC0103001-Activation=management/Activation"
set "SC0104001-Transaction=transactions/Transaction"
set "SC0106001-TransactionQuery=transactions/TransactionQuery"
set "SC0106002-DisputeNotation=dispute/DisputeNotation"
set "SC0107001-FeePayment=billing/FeePayment"
